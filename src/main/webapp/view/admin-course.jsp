...
<div class="container">
    ...
    <section>
        <form action="/admin/add_course/add" method="post" class="add-form" enctype="multipart/form-data">
    ...
    <div class="search-form">
        <form action="/admin/admin_course" method="get">
    ...
    <section class="display-table mt-3">
        <table>
            ...
            <tr>
                ...
                <td>
                    <a href="/admin/admin_course?delete=<%=row.getId()%>" class="delete-btn"
                       onclick="return confirm('are your sure you want to delete this?');"><i
                            class="fas fa-trash"></i>delete</a>

                    <a href="/admin/admin_course?edit=<%= row.getId() %>" class="option-btn"><i
    ...
    <section class="edit-form-container" style="display: none;">
        ...
        <form action="/admin/admin_course/add" method="post" enctype="multipart/form-data">
